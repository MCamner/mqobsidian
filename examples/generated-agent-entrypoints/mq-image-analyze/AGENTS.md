...
4. Read `$MQ_OBSIDIAN_DIR/memory/learn/agent/mq-image-analyze.md` if it exists.
5. Read `$MQ_OBSIDIAN_DIR/systems/mq-image-analyze/hot.md` if it exists.
6. Read `$MQ_OBSIDIAN_DIR/systems/mq-image-analyze/index.md` if it exists.
