...
4. Read `~/mqobsidian/memory/learn/agent/mq-image-analyze.md` if it exists.
5. Read `~/mqobsidian/systems/mq-image-analyze/hot.md` if it exists.
6. Read `~/mqobsidian/systems/mq-image-analyze/index.md` if it exists.
