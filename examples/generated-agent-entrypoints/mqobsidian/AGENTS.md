...
4. Read `$MQ_OBSIDIAN_DIR/memory/learn/agent/mqobsidian.md` if it exists.
5. Read `$MQ_OBSIDIAN_DIR/systems/mqobsidian/hot.md` if it exists.
6. Read `$MQ_OBSIDIAN_DIR/systems/mqobsidian/index.md` if it exists.
