...
4. Read `~/mqobsidian/memory/learn/agent/mqobsidian.md` if it exists.
5. Read `~/mqobsidian/systems/mqobsidian/hot.md` if it exists.
6. Read `~/mqobsidian/systems/mqobsidian/index.md` if it exists.
