...
4. Read `$MQ_OBSIDIAN_DIR/memory/learn/agent/mq-ums.md` if it exists.
5. Read `$MQ_OBSIDIAN_DIR/systems/mq-ums/hot.md` if it exists.
6. Read `$MQ_OBSIDIAN_DIR/systems/mq-ums/index.md` if it exists.
