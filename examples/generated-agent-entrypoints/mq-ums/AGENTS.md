...
4. Read `~/mqobsidian/memory/learn/agent/mq-ums.md` if it exists.
5. Read `~/mqobsidian/systems/mq-ums/hot.md` if it exists.
6. Read `~/mqobsidian/systems/mq-ums/index.md` if it exists.
