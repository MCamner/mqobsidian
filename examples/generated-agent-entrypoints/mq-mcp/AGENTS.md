...
4. Read `$MQ_OBSIDIAN_DIR/memory/learn/agent/mq-mcp.md` if it exists.
5. Read `$MQ_OBSIDIAN_DIR/systems/mq-mcp/hot.md` if it exists.
6. Read `$MQ_OBSIDIAN_DIR/systems/mq-mcp/index.md` if it exists.
