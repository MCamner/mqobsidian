...
4. Read `~/mqobsidian/memory/learn/agent/mq-mcp.md` if it exists.
5. Read `~/mqobsidian/systems/mq-mcp/hot.md` if it exists.
6. Read `~/mqobsidian/systems/mq-mcp/index.md` if it exists.
