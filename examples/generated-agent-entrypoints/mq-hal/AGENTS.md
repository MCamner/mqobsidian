...
4. Read `~/mqobsidian/memory/learn/agent/mq-hal.md` if it exists.
5. Read `~/mqobsidian/systems/mq-hal/hot.md` if it exists.
6. Read `~/mqobsidian/systems/mq-hal/index.md` if it exists.
