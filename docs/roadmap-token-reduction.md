...
**Blocked on 12g.** Do not implement any item below until the provider has
both won the quality gate and shown a unique cross-source capability. The
routing table is a design, not a commitment.
